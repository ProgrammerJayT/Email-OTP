...
@section('content')
    <div class="d-xl-flex flex-column align-items-xl-center">
        ...
        <div class="d-flex d-sm-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-xl-center"
            ...
            <form class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center" method="POST"
                action="{{ route('verify', [
                    'email' => $email,
                ]) }}"
                ...
                @if ($type == 'success')
                    <div class="alert alert-success d-sm-flex flex-row align-items-sm-center alert-dismissible"
                        ...
                        style="background-color: #B4F7D2!important;border: 1px solid #0C6D38;width: 100%;">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button><i
                            class="icon ion-checkmark-round me-1" style="color: var(--bs-danger);"></i>
                        <span style="color: var(--bs-danger);">{{ $message }}<br></span>
                    </div>
                @endif

                @if ($type == 'fail')
                    <div class="alert alert-danger d-sm-flex flex-row align-items-sm-center alert-dismissible"
                        role="alert" id="save-sucess-1"
                        style="border: 1px solid #0C6D38;width: 100%;background: var(--bs-danger);">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        <i class="icon ion-checkmark-round me-1" style="color: var(--bs-alert-bg);"></i>
                        <span style="color: var(--bs-white);">{{ $message }}<br></span>
                    </div>
                @endif
                ...
                <div class="input-group" style="width: 100%;">
                    ...
                    <input class="form-control form-control" type="text" placeholder="OTP" name="otp"
                ...
                <div class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center input-group"
                    style="width: 100%;margin-top: 25px;"><button class="btn btn-primary" type="submit"
                        style="width: 50%;border-radius: 20px;">Submit</button>
                </div>
                <div class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center input-group"
