    ...
    <div class="d-xl-flex flex-column align-items-xl-center">
        ...
        <div class="d-flex d-sm-flex d-xl-flex flex-column align-items-center align-items-sm-center align-items-xl-center"
            ...
            <form class="d-flex d-xl-flex flex-column align-items-center align-items-xl-center" method="POST"
                action="{{ route('validate') }}" style="width: 40%;min-width: 70%;">
                <div class="alert alert-success d-sm-flex flex-row align-items-sm-center alert-dismissible" role="alert"
                    ...
                    <span style="color: var(--bs-danger);">Intimação arquivada com sucesso<br></span>
                </div>
                <div class="alert alert-danger d-sm-flex flex-row align-items-sm-center alert-dismissible" role="alert"
                    id="save-sucess-1" style="border: 1px solid #0C6D38;width: 100%;background: var(--bs-danger);">
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <i class="icon ion-checkmark-round me-1" style="color: var(--bs-alert-bg);"></i>
                    <span style="color: var(--bs-white);">Intimação arquivada com sucesso<br></span>
                </div>
